...
import com.zte.agricul.ui.CropImageActivity;
...
public class CropImage
{
    ...
    public static final File FILE_LOCAL = new File(Constants.SCR_IMAGE_PATH,"guts");
	...
	public CropImage(Context context, CropImageView imageView,Handler handler,int wide,int high)
	{
		mContext = context;
...
//        Rect dr = mCrop.mDrawRect;
    ...
    public String saveToLocal(Bitmap bm)
    {
    	...
    	File filePath = new File(Constants.SCR_IMAGE_PATH);
    	if(!filePath.exists())
    	{
    		filePath.mkdirs();
    	}
    ...
    Runnable mRunFaceDetection = new Runnable() {
        ...
        private void makeDefault() {
            ...
            if (wide == high ) {
				...
				cropWidth = Math.min(width, height*3/5) * 4 / 5;
		        cropHeight = cropWidth*5/3;
			}
