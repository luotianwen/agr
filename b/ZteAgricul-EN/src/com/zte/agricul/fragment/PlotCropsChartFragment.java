...
public class PlotCropsChartFragment extends Fragment implements OnClickListener {
	...
	public PlotCropsChartFragment(String id,List<PlotBean >  plotList) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.fragment_plot_crops_chart, container,
				false);
			...
			public void run() {
				if (NetworkUtil.isNetworkAvailable(getActivity())) {
					...
					if (null != sb) {
						...
						mBean = ResolveJson.cropsChartParse(sb.toString());
