...
public class PlotCropSpinnerAdapter extends BaseAdapter {
	// private Context mContext;
	private List<PlotBean> cityBeans;
	private LayoutInflater mLayoutInflater;
	private Context mContext;
	private ViewHolder viewHolder = null;
	int unreadNum ;
	
	public PlotCropSpinnerAdapter(Context mContext, List<PlotBean> cityBeans) {
		super();
