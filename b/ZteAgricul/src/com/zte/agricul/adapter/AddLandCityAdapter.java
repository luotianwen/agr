...
public class AddLandCityAdapter extends BaseAdapter {
	...
	public AddLandCityAdapter(Context mContext, List<CityBean> cityBeans) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (viewRoot == null) {
			viewRoot = mLayoutInflater.inflate(R.layout.item_crop_all_list,
					null);
